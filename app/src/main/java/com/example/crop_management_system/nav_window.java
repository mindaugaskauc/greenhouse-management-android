 ...
 * Use the {@link nav_window#newInstance} factory method to
 * create an instance of this fragment.
 */
public class nav_window extends Fragment {
    ...
    public static nav_window newInstance(String param1, String param2) {
        nav_window fragment = new nav_window();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_nav_window, container, false);
        Switch switchButton = (Switch) root.findViewById(R.id.switch2);
        ...
        switchButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                //String water_crop; // create a watercrop variable
                String window_control; // create a control_window variable
                ...
                /*    // The toggle is enabled
                  ...
                  */
                    // The toggle is enabled
                   // water_crop = "1";
                    window_control = "WINDOW OPENS";
                    String apiKey = Tools.postWindowOnURL;
                    ...
                    { //Create an error listener to handle errors appropriately.
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            MyData.put("window_control", window_control); //Add the data you'd like to send to the server.
                            return MyData;
                        }
                    ...
                    //water_crop = "0";
                    window_control = "WINDOW CLOSES";
                    String apiKey = Tools.postWindowOffURL;
